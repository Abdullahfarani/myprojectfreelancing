...
const Card = () =>{
  useEffect(()=>{
    ...
    return (
        <>
        <div  className="fourpicwithwriting " data-aos="zoom-in">
          <div>
        <div className="fourpic">
          <div className="">
            <div className="card bg-dark " style={{width: "18rem",height:"20rem",boxShadow:"2px 3px 10px white"}}>
            <div className="card-body cardbody">
            <span className="fourpiclogoborder">
            <svg xmlns="http://www.w3.org/2000/svg" className=""   width="37" height="38.134" viewBox="0 0 37 38.134">
  <defs>
  ...
  <g id="profuct_design_-_icon" data-name="profuct design - icon" transform="translate(-27.328 -15.227)">
    ...
    <path id="Path_63" data-name="Path 63" d="M0,0H4.916V2.119H0Z" transform="translate(27.328 42.86) rotate(-25.54)" fill="url(#linear-gradient)"></path>
                ...
                <h4 style={{fontWeight:"bold",color:"white"}}>Product design</h4>
            <p className="card-text" style={{color:"white"}}>The technological revolutional changing the aspect.</p>
            </div>
            </div>
            </div>
            <div className="card fourpicmarginT bg-dark" style={{width: "18rem",boxShadow:"2px 3px 10px white"}}>
    ...
    <g id="Group_131" data-name="Group 131" transform="translate(8.837 8.838)">
      <g id="Group_130" data-name="Group 130">
        <path id="Path_75" data-name="Path 75" d="M140.535,134.643,131.771,121.5h0l-.01-.014c-.015-.022-.031-.043-.047-.063a1.1,1.1,0,0,0-1.754.063l-.01.014h0l-8.764,13.146a1.1,1.1,0,0,0,.137,1.382,13.879,13.879,0,0,1,3.956,8.1,5.651,5.651,0,0,0-.49.444,5.553,5.553,0,0,0-1.6,3.9,1.1,1.1,0,0,0,1.1,1.1h13.146a1.1,1.1,0,0,0,1.1-1.1,5.553,5.553,0,0,0-1.6-3.9,5.642,5.642,0,0,0-.49-.444,13.877,13.877,0,0,1,3.956-8.1A1.1,1.1,0,0,0,140.535,134.643Zm-9.675-.488a1.1,1.1,0,1,1-1.1,1.1A1.1,1.1,0,0,1,130.859,134.155Zm-5.291,13.219a3.346,3.346,0,0,1,3.1-2.264h4.382a3.346,3.346,0,0,1,3.1,2.264Zm8.814-4.288a5.382,5.382,0,0,0-1.332-.167h-4.382a5.378,5.378,0,0,0-1.332.167,16.075,16.075,0,0,0-3.845-7.953l6.273-9.41v6.43a3.286,3.286,0,1,0,2.191,0v-6.43l6.273,9.41A16.073,16.073,0,0,0,134.383,143.086Z" transform="translate(-121 -121.01)" stroke="#2d2e32" strokeWidth="0.5" fill="url(#linear-gradient)"></path>
            ...
            <h4 style={{fontWeight:"bold",color:"white"}}>Logo design</h4>
            <p className="card-text" style={{color:"white"}}>The technological revolutional changing the aspect.</p>
            </div>
            </div>
        ...
        <div className="fourpic">
            ...
            <div className="card bg-dark " style={{width: "18rem",height:"20rem",boxShadow:"2px 3px 10px white"}}>
            <div className="card-body cardbody">
            <span className="fourpiclogoborder" style={{marginBottom:"20px"}}> 
            <svg id="ui_design_-_icon" data-name="ui design - icon"   width="37" height="37" viewBox="0 0 37 37">
  <defs>
    <linearGradient id="linear-gradient" x1="0.5" x2="0.5" y2="1" gradientUnits="objectBoundingBox">
      <stop offset="0" stopColor="#64f4ab"></stop>
      <stop offset="1" stopColor="#327a56"></stop>
  ...
  <g id="Group_111" data-name="Group 111" transform="translate(0 0)">
    <path id="Path_65" data-name="Path 65" d="M37,18.5a1.084,1.084,0,0,0-.515-.92l-3.76-2.318,3.764-2.343a1.084,1.084,0,0,0,0-1.839L19.076.165a1.084,1.084,0,0,0-1.151,0L.508,11.077a1.084,1.084,0,0,0,0,1.839L4.25,15.243.509,17.581a1.084,1.084,0,0,0,0,1.84L4.25,21.747.509,24.085a1.084,1.084,0,0,0,0,1.838L17.924,36.835a1.084,1.084,0,0,0,1.151,0L36.491,25.923a1.084,1.084,0,0,0-.007-1.841l-3.76-2.318,3.764-2.343A1.084,1.084,0,0,0,37,18.5ZM3.13,11.993,18.5,2.363l15.369,9.63L18.5,21.559ZM33.862,25.011,18.5,34.637,3.127,25.005,6.3,23.023,17.927,30.26a1.084,1.084,0,0,0,1.146,0l11.6-7.217ZM18.5,28.063,3.132,18.5,6.3,16.519l11.628,7.237a1.084,1.084,0,0,0,1.146,0l11.6-7.217L33.857,18.5Z" transform="translate(0 0)" fill="url(#linear-gradient)"></path>
                ...
                <h4 style={{fontWeight:"bold",color:"white"}}>UI design</h4>
            <p className="card-text" style={{color:"white"}}>The technological revolutional changing the aspect.</p>
            </div>
            </div>
          
            <div className="card bg-dark fourpicmarginT " style={{width: "18rem",boxShadow:"2px 3px 10px white"}}>
            <div className="card-body cardbody">
            <span className="fourpiclogoborder" style={{marginBottom:"20px"}}> 
            <svg id="icon_design_-_icon" data-name="icon design - icon"  width="37" height="41.4" viewBox="0 0 37 41.4">
  <defs>
    <linearGradient id="linear-gradient" x1="0.5" x2="0.5" y2="1" gradientUnits="objectBoundingBox">
      <stop offset="0" stopColor="#64f4ab"></stop>
      <stop offset="1" stopColor="#327a56"></stop>
  ...
  <g id="Group_113" data-name="Group 113" transform="translate(3.265 8.208)">
    <g id="Group_112" data-name="Group 112">
      <path id="Path_66" data-name="Path 66" d="M62.978,86.08H58.073a.763.763,0,1,0,0,1.526h4.905a.763.763,0,1,0,0-1.526Z" transform="translate(-57.31 -86.08)" fill="url(#linear-gradient)"></path>
    </g>
  </g>
  <g id="Group_115" data-name="Group 115" transform="translate(3.265 14.792)">
    <g id="Group_114" data-name="Group 114">
      <path id="Path_67" data-name="Path 67" d="M62.978,155.12H58.073a.763.763,0,0,0,0,1.526h4.905a.763.763,0,0,0,0-1.526Z" transform="translate(-57.31 -155.12)" fill="url(#linear-gradient)"></path>
    </g>
  </g>
  <g id="Group_117" data-name="Group 117" transform="translate(3.265 21.398)">
    <g id="Group_116" data-name="Group 116">
      <path id="Path_68" data-name="Path 68" d="M62.978,224.4H58.073a.763.763,0,0,0,0,1.526h4.905a.763.763,0,0,0,0-1.526Z" transform="translate(-57.31 -224.4)" fill="url(#linear-gradient)"></path>
    </g>
  </g>
  <g id="Group_119" data-name="Group 119" transform="translate(3.265 28.042)">
    <g id="Group_118" data-name="Group 118">
      <path id="Path_69" data-name="Path 69" d="M62.978,294.08H58.073a.763.763,0,0,0,0,1.526h4.905a.763.763,0,0,0,0-1.526Z" transform="translate(-57.31 -294.08)" fill="url(#linear-gradient)"></path>
    </g>
  </g>
  <g id="Group_121" data-name="Group 121" transform="translate(15.024 8.788)">
    <g id="Group_120" data-name="Group 120">
      <path id="Path_70" data-name="Path 70" d="M186.169,94.27l-4.463-2.044a.763.763,0,0,0-.633,1.388h0l4.463,2.044a.763.763,0,1,0,.633-1.388Z" transform="translate(-180.626 -92.157)" fill="url(#linear-gradient)"></path>
    </g>
  </g>
  <g id="Group_123" data-name="Group 123" transform="translate(0)">
    <g id="Group_122" data-name="Group 122">
      <path id="Path_71" data-name="Path 71" d="M58.817,12.663,56.322,9.734a4.768,4.768,0,0,0-3.173-1.739,4.493,4.493,0,0,0-3.3,1.251l-1.732,1.526.664-1.442A4.168,4.168,0,0,0,48.5,4.8a5.141,5.141,0,0,0-1.976-1.526L43.064,1.64a4.244,4.244,0,0,0-6.057,2.289l-.969,2.113V4.577A4.253,4.253,0,0,0,31.461,0H27.647A4.253,4.253,0,0,0,23.07,4.577V36.823A4.253,4.253,0,0,0,27.647,41.4h3.814a4.1,4.1,0,0,0,4.3-2.845l22.58-19.483a4.5,4.5,0,0,0,1.724-3.051A4.761,4.761,0,0,0,58.817,12.663Zm-24.3,24.159a2.767,2.767,0,0,1-3.051,3.051H27.647A2.767,2.767,0,0,1,24.6,36.823V4.577a2.768,2.768,0,0,1,3.051-3.051h3.814a2.767,2.767,0,0,1,3.051,3.051Zm3.639-13.937-2.113-.946V16.371l4.211,1.922a.763.763,0,1,0,.633-1.388L36.42,14.868a.762.762,0,0,0-.381-.053V9.681L38.4,4.547a2.783,2.783,0,0,1,4.035-1.526l3.486,1.594a3.624,3.624,0,0,1,1.4,1.068,2.708,2.708,0,0,1,.1,2.967L39.875,25.128l-3.814,8.391V23.6l1.457.671a.763.763,0,0,0,.633-1.388Zm19.2-4.974L36.71,35.724l4.066-8.887,1.053,1.205a.763.763,0,1,0,1.19-.955.79.79,0,0,0-.053-.06l-1.526-1.671,2.35-5.126,3.006,3.486A.779.779,0,0,0,47.977,22.7l-3.219-3.73a.763.763,0,0,0-.305-.206l2.151-4.7L50.86,10.4a3.052,3.052,0,0,1,2.189-.885,3.219,3.219,0,0,1,2.1,1.205l2.5,2.906a3.326,3.326,0,0,1,.885,2.289A3.052,3.052,0,0,1,57.352,17.912Z" transform="translate(-23.07 0)" fill="url(#linear-gradient)"></path>
    </g>
  </g>
  <g id="Group_125" data-name="Group 125" transform="translate(25.384 14.409)">
    <g id="Group_124" data-name="Group 124">
      <path id="Path_72" data-name="Path 72" d="M293.8,155.067l-3.2-3.715a.763.763,0,0,0-1.152,1l3.2,3.715a.763.763,0,0,0,1.152-1Z" transform="translate(-289.271 -151.106)" fill="url(#linear-gradient)"></path>
    </g>
  </g>
  <g id="Group_127" data-name="Group 127" transform="translate(3.829 32.779)">
    <g id="Group_126" data-name="Group 126">
      <path id="Path_73" data-name="Path 73" d="M65.885,343.76a2.655,2.655,0,1,0,2.655,2.655A2.655,2.655,0,0,0,65.885,343.76Zm0,3.784v.031a1.114,1.114,0,1,0,0-.031Z" transform="translate(-63.23 -343.76)" fill="url(#linear-gradient)"></path>
    </g>
  </g>
</svg>
              </span>
                <h4 style={{fontWeight:"bold",color:"white"}}>Icon design</h4>
            <p className="card-text" style={{color:"white"}}>The technological revolutional changing the aspect.</p>
            </div>
            </div>
...
<div>
<h4 className="introclass"> --- Introducing</h4>
<h1 className="introclass">Why Hire Me For Next <br/> Project?</h1>
<h6 className="paragraphclass">The technological revolution is changing aspect of <br></br>our lives, and the fabric of society itself. it's also changing<br></br> the way we learn and what we learn.<br></br> Factual knowledge is less prized when everything you<br></br> ever need to know can be found on your phone. <br></br>There's no imperative to be an expert at doing <br></br>everything when you can.</h6>
<button type="button" className="btn btn-warning my-3 mx-5 btn-lg">Download CV </button>   
</div>
</div>
     </>
    );
